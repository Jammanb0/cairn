...
만드는 워크스트림의 번호는 이 세팅 다음 번호부터 씁니다. 원본 문서를 지울지는
사람에게 묻습니다.
...
지우기 전에 다섯 가지를 모두 확인합니다. 하나라도 아니면 지우지 않습니다.
...
4. **`.agents/plans/workstreams.md`의 「마칠 때」와 「반영할 때」를 그대로
   따릅니다.** 반영, 대상 위치 검증, 이력 기록, 아카이브 이동, 최종 기록
   커밋과 브랜치 정리가 거기 있습니다. 아카이브로 옮기는 것은 사용자 허락을
   받고 합니다. 같은 절차를 여기에 다시 적지 않습니다.
