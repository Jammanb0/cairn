...
후보를 확인하는 방법은 `.cairn/template/.agents/plans/workflow.md`의
「대작업 관리 흐름」 4번이 원본입니다. 0번에서 본 현재 브랜치와 upstream, 원격
...
무엇을 어떤 순서로 묻는지는 `.cairn/template/.agents/plans/workflow.md`의
「대작업 관리 흐름」 5번이 원본입니다. 그대로 따르되, 작업 브랜치 이름 자리에는
